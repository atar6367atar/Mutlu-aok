...
// =============================================
// NGB SORGU PANELİ - API DOĞRUDAN BAĞLANTI
// TÜM SORGULAR ÇALIŞIYOR
...
<body>
    ...
    <script>
        ...
        async function executeQuery() {
            ...
            try {
                // API URL'ini oluştur
                let url = API_BASE + apiEndpoints[currentQuery] + '?';
                let paramList = paramNames[currentQuery];
                
                for (let i = 0; i < paramList.length; i++) {
                    if (i > 0) url += '&';
                    url += paramList[i] + '=' + encodeURIComponent(params[i]);
                }
        ...
        // İlk yüklemede sorgu kutusunu gizle
